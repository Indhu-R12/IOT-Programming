...
data={'UserName':UserName,'UserAge':UserAge,'UserCity':UserCity,'UserSate':UserState}
print(data)

# Saving data to DB
cur.execute("INSERT INTO users (UserName,UserAge,UserCity,UserState) VALUES (%(UserName)s,%(UserAge)s,%(UserCity)s,%(UserState)s);",data)
conn.commit()
print("saved to db")
